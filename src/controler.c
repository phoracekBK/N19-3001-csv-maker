...
static c_linked_list * controler_compose_csv(uint8_t * buffer)
{
  ...
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone1"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone1_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone2"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone2_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone3"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone3_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone4"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone4_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone5"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone5_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone6"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone6_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone7"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone7_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone8"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone8_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone9"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone9_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone10"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone10_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone11"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone11_status(buffer));
  csv_struct = controler_add_csv_item(csv_struct, c_string_init("MetralightZone12"), c_string_init("OK/NOK/ERR/NaN"), cp_get_metralight_zone12_status(buffer));
